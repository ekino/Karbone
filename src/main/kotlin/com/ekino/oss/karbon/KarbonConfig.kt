...
public data class KarbonConfig(
  /**
  ...
  val userAgent: String = "karbon/$VERSION",
) {
  init {
  ...
  internal constructor(
    ...
    public var userAgent: String = "karbon/$VERSION"
  ...
  public companion object {
    ...
    public fun cloud(apiKey: String, configure: Builder.() -> Unit = {}): KarbonConfig =
    ...
    ): KarbonConfig = Builder(baseUrl, token, null).apply(configure).build()
  }
}
